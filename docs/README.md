...
Simplified Chinese: [docs/zh-CN/README.md](zh-CN/README.md)

## Overview

This index links to the main technical docs for building, configuring, and operating `ipmi-fan-control`.
